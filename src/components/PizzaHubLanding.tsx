    ...
    <div className="roma-shell">
      <header className="roma-header">
        <div className="roma-container roma-header-inner">
          ...
          <div className="roma-header-actions">
            <a href={`tel:${settings.phone}`} className="roma-icon-link" aria-label="اتصل بنا">
              <Phone size={18} />
            </a>
            <Link href="/menu" className="roma-order-button">
              <ShoppingBag size={17} />
              اطلب الآن
            </Link>
            <button type="button" className="roma-menu-button" aria-label="فتح القائمة">
              <Menu size={20} />
            </button>
          </div>
        </div>
      ...
      <main>
          ...
          <div className="roma-container roma-hero-grid">
            <div className="roma-hero-copy">
              ...
              <div className="roma-hero-actions">
                <Link href="/menu" className="roma-primary-cta">
                  شاهد المنيو <ArrowLeft size={18} />
                </Link>
                <a href={`https://wa.me/${settings.whatsapp}`} className="roma-secondary-cta">
                  اطلب عبر واتساب
                </a>
              </div>
              ...
              {featured.map((product, index) => (
                <article className="roma-product-card" key={product.id}>
                  ...
                  <div className="roma-product-body">
                    ...
                    <div>
                      <strong>{product.price ? `${product.price} د.ل` : "السعر عند الطلب"}</strong>
        ...
        <section id="gallery" className="roma-section roma-gallery">
          <div className="roma-container">
            <div className="roma-section-head roma-section-head-centered">
              <div>
                <span>من أجوائنا</span>
                <h2>كل صورة تحكي طعمًا</h2>
              </div>
            </div>
        ...
        <section className="roma-cta">
          ...
          <div className="roma-container roma-cta-content">
            ...
            <h2>خلي عشا اليوم من De Roma</h2>
            <p>اختر اللي يعجبك، أرسل الطلب، وخلي الباقي علينا.</p>
            <div className="roma-hero-actions">
              <Link href="/menu" className="roma-primary-cta">اطلب من المنيو <ArrowLeft size={18} /></Link>
              <a href={`https://wa.me/${settings.whatsapp}`} className="roma-secondary-cta roma-secondary-cta-light">واتساب</a>
            </div>
          </div>
        </section>
      </main>
      ...
      <footer className="roma-footer">
        <div className="roma-container roma-footer-grid">
          <div>
            <Link href="/" className="roma-brand roma-brand-footer">
              <span className="roma-brand-mark">DR</span>
              <span className="roma-brand-copy"><strong>{settings.restaurant_name}</strong><small>Italian Pizza & Pastry</small></span>
            </Link>
